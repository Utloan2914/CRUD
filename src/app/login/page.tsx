                        ...
                        <Col md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
                            ...
                            <Form onSubmit={handleSubmit} className='d-flex flex-column align-items-center'>
                                ...
                                <div className="d-flex flex-row align-items-center mb-4">
                                    ...
                                    <Input type={showPassword ? 'text' : 'password'} name='password' placeholder='Mật khẩu' value={formData.password} onChange={handleChange} />
                                    <i
                                        className={`fas ${showPassword ? 'fa-eye-slash' : 'fa-eye'} me-3`}style={{ fontSize: '1.5rem', cursor: 'pointer', marginLeft: '10px' }}
                                ...
                                <Button type="submit" id="button" className='mb-4' size='lg'>Đăng nhập</Button>
                            </Form>
                        </Col>
